...
date: 2026-06-10
tags: [code]
thumbnail: assets/posts/alfolio.png
toc:
    - name: I. Creating a github repository for your website
    - name: Some basic info about your website repo
    - name: II. Deploying the site
    - name: III. About page
    - name: IV. Publications page
    - name: V. CV
    - name: VI. Google search console
...
- **II.1** in the github interface, go to the *Actions* tab and wait until all actions for your last commit have finished (some may fail). (~2 to 5 min)
...
Your publications page is defined in `_pages/publications` and reads automatically the file `_bibliography/papers.bib`. Some `bibtex` fields will be rendered as clickable buttons on your publication page. Here's an example below:
